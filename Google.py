...
dicionari_token_credencial_n = {
    'PC-I5-8600K_PokerIP': ("token1.json", "credentials0.json", 1, 'gayaluisaalmeida@gmail.com', 'lglg32379089'),
    ...
    'PC-I5-13400E_PokerIP': ("token31.json", "credentials4.json", 31, 'gayaluisaalmeida@gmail.com', 'lglg32379089'),
...
def lote_valor(guia, linha):
    ...
    regiao1 = f"{dicionari_PC_IP[nome_computador]}"  # pega a contagem de ip
